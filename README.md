...
- **Explainable AI (XAI)** - SHAP, LIME, PDP for tabular medical and financial data
...
### [XAI for Heart Disease Prediction](#)
*Python · scikit-learn · XGBoost · SHAP · LIME | M.Tech Minor Project, DEI Agra*

Multi-model XAI study on the UCI Cleveland Heart Disease dataset (303 patients, 13 features). Compared Logistic Regression, Decision Tree, Random Forest, and XGBoost using SHAP and LIME. Identified ca, thal, cp, and thalach as dominant predictors. Includes cross-fold SHAP stability analysis and gender-wise fairness analysis (FNR gap: female 14.3% vs male 4.8%). Best model: Random Forest at 88.52% accuracy.

### [XAI for Financial Decision-Making](https://github.com/06hpathak/xai-german-credit)
*Python · XGBoost · SHAP · PDP · LIME | Self-Study CSM961, DEI Agra*
...
Simulations built:
- **Flywheel** - moment of inertia and rotational energy
- **Gyroscope** - angular momentum and precession
- **Simple Pendulum** - period-length relationships
...
### [12-Candles](https://github.com/thesiriusacademy/tsa-12candles-ui)
*Next.js · React.js · Tailwind CSS · REST APIs | TSA Edtech Pvt. Ltd*

Dynamic, responsive UI with live RESTful API integration and async data fetching for real-time updates.

### [TSA Dashboard](https://github.com/thesiriusacademy/tsa-dashboard)
*React.js · Material UI · Mantis · Ant Design · REST APIs | TSA Edtech*
...
- 🗄️ IBM: Database & SQL for Data Science with Python (Honors)
